...
<div>
    ...
    <div x-data="{ showAlert: false, alertType: '', alertMessage: '' }" 
         x-show="showAlert" 
         x-transition
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="text-success fw-bold mb-1">Rp {{ number_format($service->price, 0, ',', '.') }}</p>
                        ...
                        <form wire:submit="saveService">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    @error('image_url') <span class="text-danger small">{{ $message }}</span> @enderror
                                    
                                    @if($image_url)
                                        <div class="mt-2">
                                            <img src="{{ $image_url->temporaryUrl() }}" class="img-thumbnail" style="max-height: 100px;">
                                        </div>
                                    @endif
                                </div>
                            </div>
